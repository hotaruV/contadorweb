window.onload = () => {
    ...
    primero.addEventListener('click', () => {
        ...
        tercero.classList.remove('link--active')
        cuarto.classList.remove('link--active')
        gsap.to(".about", { duration: 1, rotationX: 360 });
        gsap.from(".texto-boton", { duration: 1, x: 300, opacity: 0 });
    ...
    segundo.addEventListener('click', () => {
        ...
        tercero.classList.remove('link--active')
        cuarto.classList.remove('link--active')
        gsap.from(".card_img", { duration: 1, x: 360, opacity: 1 });
    ...
    tercero.addEventListener('click', () => {
        ...
        cuarto.classList.remove('link--active')
        gsap.from(".container-bg", { duration: 2, x: 300, opacity: 0, scale: 0.5 });
        gsap.from(".card", { duration: 2, x: 200, ease: "bounce" });
